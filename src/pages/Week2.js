    ...
    return (
        <div>
            ...
            <p>
                ...
                Haluatko harjoitella tällä viikolla oppimiasi asioita? <Link to="/sammy2">Sammy</Link> näyttäisi olevan edelleen avun tarpeessa.<br/><br/><br/>
            </p>
            <p>
                In the second week, you deepened your knowledge of Java and testing, and practiced test driven development.<br/><br/>
