...
const SammysAdventuresPart1 = () => {
    return (
        <div>
            <h1>Sammyn Seikkailut / Sammy's Adventures - Part 1</h1><br/>
            <p>
                Sammy-orava valmistautuu pitkään kylmään talveen. Hän on ollut ahkera ja kerännyt 20 käpyä joka päivä viimeisen kahden viikon aikana.<br/><br/>
                ...
                1. Kirjoita metodi, joka laskee kuinka monta käpyä Sammy on kerännyt tähän mennessä.<br/><br/>
            ...
            <p>
                Sammy the squirrel is preparing for a long, cold winter. He has been busy collecting pine cones and has collected 20 every day for the past 2 weeks.<br/><br/>
                ...
                1. Write a method that calculates how many pine cones Sammy has collected so far.<br/><br/>
                ...
                There are several ways to get the right solution. You will know your code works when it passes all the tests in the test file.
            </p>
...
export default SammysAdventuresPart1;